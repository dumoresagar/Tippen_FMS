...
urlpatterns = [
    ...
    path("district-wise-bel-count/", DistrictWiseBelCountView.as_view(), name="district-wise-bel-count"),
    path("district-wise-bel-list/<int:pk>/", BelDocumentListAPI.as_view(), name="district-wise-bel-list"),

    path("agency-maptype-wise-count/", AgencyMapTypeWiseDashboardView.as_view(), name="agencymaptype-wise-count"),
    path('month-wise-document-count/', MonthWiseDocumentCountAPIView.as_view(), name='month-wise-document-count'),
